...
test('mobile travel notebook presentation is bundled and protected from CDN regressions', () => {
  assert.match(html, /css\/utilities\.css\?v=1\.4\.0/);
  assert.match(html, /css\/companion\.css\?v=1\.4\.0/);
  assert.match(html, /js\/presentation\/companion-ui\.js\?v=1\.4\.0/);
  ...
  for (const asset of [
    'css/utilities.css?v=1.4.0',
    'css/companion.css?v=1.4.0',
    'js/presentation/companion-ui.js?v=1.4.0',
