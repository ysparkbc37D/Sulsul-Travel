...
> **v1.8.1 / 2026-09-14**: 지출 카드를 눌러 잘못된 내역과 물건 사진을 편집합니다. 대표사진 썸네일과 가계부 버튼 크기를 통일했습니다. [사용법·검증 범위](docs/expense-editor-v1.8.1.md).

> **v1.8.0 / 2026-09-14**: 각 일정에서 완료 여부와 관계없이 사진·에세이를 기록하고 AI로 다듬습니다. 카드에는 대표사진 한 장만 표시하며 기록 탭·PDF·선택 공유까지 연결합니다. [사용법·구조·검증 범위](docs/activity-records-v1.8.0.md). 하루 자유 기록 여러 편과 실시간 공동편집은 후속입니다.
...
├── index.html                     # 술술트래블 단일 파일 SPA 코어 (v1.3.8)
├── kb-travel.js                   # 여행 도메인 지식 베이스 (환율, 22일 남미 시드 데이터)
├── manifest.webmanifest           # PWA 웹 매니페스트
├── sw.js                          # 오프라인 캐싱 Service Worker (st-shell-v1.3.8)
