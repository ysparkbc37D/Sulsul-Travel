...
> **v1.8.0 구현 추가**: [일정 기록 저장 모델·AI 승인·사진 경계·공유 연결](activity-records-v1.8.0.md). v1.7.9 저장/공유 기반 위에 일정별 기록을 독립 보존한다.

> **현행 검토: 2026-09-13 / v1.7.8** — [현재 구조·검증 결과·개선 단계](review-v1.7.8-2026-09-13.md)를 우선 참조하세요. 아래와 기존 vnext 문서의 구현 상태는 역사적 기준입니다.
