...
> **2026-09-13 업데이트**: [v1.7.8 통합 아키텍처 검토](review-v1.7.8-2026-09-13.md)에 최신 구현과 실제 재현 결과, 복수 기록·동행 동기화·보고서 데이터 모델 및 이전 순서를 정리했습니다. 아래 v1.2.4 기준의 완료/후속 표시는 당시 상태로 보존합니다.
